...
<div class="main-content">
    <section class="section">
        <?php if (session()->get('jabatan') == 'Super Admin' or session()->get('jabatan') == 'Editor') : ?>
        ...
        <?php endif ?>
        <!-- tampilan Wartawan -->
        <?php if (session()->get('jabatan') == 'Wartawan') : ?>
            <div class="section-header">
                <h1>Data Berita</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active">
                ...
                <?php endif ?>
                <?php if (session()->getFlashdata('pesanakses')) : ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <span class="fas fa-check fe-16 mr-2"></span> <?= session()->getFlashdata('pesanakses'); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                        foreach ($berjoin as $bd):
                                            if ($bd->id_pegawai == session()->get('id_pegawai')):
                                        ?>
                                                <tr>
                                                    <td class="align-middle"><?= $i++ ?></td>
                                                    <td class="align-middle"><?= $bd->judul ?></td>
