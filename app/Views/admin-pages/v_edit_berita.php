...
<div class="main-content">
    <section class="section">
        ...
        <?php foreach ($ber as $dt) : ?>
            <form action="edittberita/<?= $dt->id_berita ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-7">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="mytextarea" name="isi"><?= $dt->isi; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12 col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="kateg" class="form-control" id="">
                                                    <?php foreach ($subkat as $sd):
                                                        if ($dt->id_subkategori == $sd->id_subkategori) {
                                                    ?>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <?php foreach ($label as $ld): ?>
                                                    <label class="selectgroup-item">
                                                        <input type="checkbox" name="label[]" value="<?= $ld['id_label'] ?>" class="selectgroup-input"
                                                            <?php foreach ($lb as $berita_label): ?>
                                                            <?php if ($dt->id_berita == $berita_label->id_berita && $ld['id_label'] == $berita_label->id_label) {
                                                                    echo "checked";
                                                                } else {
                                                                    echo "";
                                                                } ?>
                                            ...
                                            <?php foreach ($lb as $berita_label): ?>
                                                <input type="hidden" value="<?= $berita_label->id ?>" name="id[]">
                                            <?php endforeach; ?>
